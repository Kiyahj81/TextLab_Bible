...
- **Reader** at `/read`
  ...
  - Verse and chapter navigation — dropdowns plus a free-text reference quick-jump (type "John 3:16") in the controls and the always-visible sticky bar — and last-passage restore (applied server-side on a bare `/read` visit).
- **Search** at `/search`
