...
Review-driven pass over `/read` (plan: `docs/superpowers/plans/2026-06-17-read-page-improvements.md`). Phases A–E (the review-finding pass) have shipped, plus the first feature phase (F, reference quick-jump).
